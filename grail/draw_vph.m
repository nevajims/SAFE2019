function draw_vph(data_freq,data_ph_vel,mode_index,data_no_modes,data_mode_start_indices,freq,freq_lims,handle);
...
axis([freq_lims(1)/1000 freq_lims(2)/1000 0 10]);
