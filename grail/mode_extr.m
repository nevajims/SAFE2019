...
notch_depths=  [0 20 40 60 80; 0 400 800 1200 1600];
...
for excite_mode_index=1:no_excite_modes
    ...
    for file_number=1:size(data_extract_files,1);
        ...
        for count=1:length(extract_modes);
            ...
            mode_shapes(:,count)=interp1(data_freq(start_index:end_index),data_ms_z(data_perimeter_node_list,start_index:end_index)',cent_freq,'cubic')';
        end;
